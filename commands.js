...
const fs = require('fs');
const ownerNumber = ['212658323376']
const prefix = '.'
...
mek = mek.messages[0]
 ...
 //_______________________________________________________________________________________________________________________________________________________   //		      
	      ...
	      case "mfire" : 
		try {
		if (!q) return await conn.sendMessage(from , { text: 'اين هو رابط ميديافاير' }, { quoted: mek } )
  ...
  if ( file.filesize > 200) return await conn.sendMessage(from , { text: mx }, { quoted: mek } )
 ...
 //_______________________________________________________________________________________________________________________________________________________   //		      
	      ...
	      case "instagram" : 
		try {
		if (!q) return await conn.sendMessage(from , { text: 'اين هو رابط فيديو' }, { quoted: mek } )
 ...
 //_______________________________________________________________________________________________________________________________________________________   //		      
		...
		// playstore // 
	      ...
	      case "apk" :
		     ...
		     const data2 = await axios.get('https://apime.ml/api.php?id=' + q)
...
╰────────────────────╯
  ...
  // _ _ _ _ _ _ _ _ __  _ _ _ _ _ _  __  _ _ _ __ _  __ _  _ _ _ _ __ _ _  __  __ _  _ __  _ __ _ _ _  _ __ _  _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ __  __ _  __ _ _ _ _   //   		      
		...
		const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            + 'VERSION:3.0\n' 
            + `FN:` + 'noureddine_ouafy' + `\n` // full name
            + 'TEL;type=CELL;type=VOICE;waid=' + '212658323376' + ':+' + '212658323376' + '\n' // WhatsApp ID + phone number
            + 'END:VCARD'
 await conn.sendMessage(from,{ contacts: { displayName: 'Error404' , contacts: [{ vcard }]  }} , { quoted: mek })      
		      break 
 //_______________________________________________________________________________________________________________________________________________________   //		      
